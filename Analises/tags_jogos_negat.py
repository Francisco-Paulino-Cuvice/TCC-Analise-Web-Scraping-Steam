...
#
# Tags comuns entre jogos com avaliações negativas
#



# Filtro dos jogos com avaliação negativa
filtro = df['total_reviews'].str.contains('Negative', na=False)
...
plt.title("Top 10 Tags entre jogos de avaliações negativas")
